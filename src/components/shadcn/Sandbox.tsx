...
export const SandboxLayout = ({ className, ...props }: SandpackLayoutProps): ReactNode => (
	<SandpackLayout className={cn("!rounded-none !border-none !bg-transparent !h-full", className)} {...(props as any)} />
);
...
export const SandboxTabs = ({
	...
	return (
		<SandboxTabsContext.Provider value={{ selectedTab, setSelectedTab }}>
			<div
				className={cn("group relative flex size-full flex-col overflow-hidden rounded-lg border text-sm", className)}
				{...(props as any)}
...
export const SandboxTabsTrigger = ({ className, value, ...props }: SandboxTabsTriggerProps): ReactNode => {
...
export const SandboxTabsContent = ({ className, value, ...props }: SandboxTabsContentProps): ReactNode => {
...
export const SandboxCodeEditor = ({ showTabs = false, ...props }: SandboxCodeEditorProps): ReactNode => (
...
export const SandboxFileExplorer = ({
	...
	<SandpackFileExplorer autoHiddenFiles={autoHiddenFiles} className={cn("h-full", className)} {...(props as any)} />
);
