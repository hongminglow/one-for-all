  ...
  return (
    <SheetPortalPrimitive>
      ...
      <SheetContentPrimitive
        className={cn(
          "bg-background fixed z-50 flex flex-col gap-4 shadow-lg p-6",
          side === "right" && "h-full w-[350px] border-l right-0",
          side === "left" && "h-full w-[350px] border-r left-0",
          side === "top" && "w-full h-[350px] border-b top-0",
          side === "bottom" && "w-full h-[350px] border-t bottom-0",
          className,
        )}
        side={side}
        {...props}
