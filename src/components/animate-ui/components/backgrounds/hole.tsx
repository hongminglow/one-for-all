...
function HoleBackground({
  ...
  const setLines = React.useCallback(() => {
    ...
    const currentColor =
      strokeColor || (isDarkRef.current ? "#525252" : "#e5e5e5");
  ...
  return (
    <div
      ...
      className={cn(
        ...
        'before:content-[""] before:absolute before:top-1/2 before:left-1/2 before:block before:size-[140%] dark:before:bg-[radial-gradient(ellipse_at_50%_55%,transparent_10%,#09090b_50%)] before:bg-[radial-gradient(ellipse_at_50%_55%,transparent_10%,white_50%)] before:transform-[translate3d(-50%,-50%,0)]',
    ...
    >
      ...
      <canvas
        ref={canvasRef}
        className="absolute inset-0 block size-full dark:opacity-40 opacity-10"
      />
      <motion.div
        className={cn(
