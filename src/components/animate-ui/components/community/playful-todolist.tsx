...
function PlayfulTodolist() {
  ...
  return (
    <div className="bg-white dark:bg-zinc-950 rounded-2xl p-6 shadow-sm border border-neutral-200 dark:border-zinc-800 space-y-6">
          ...
          <div className="flex items-center space-x-2">
            ...
            <div className="relative inline-block">
              <Label
                ...
                className="text-neutral-900 dark:text-neutral-100 transition-colors"
              >
                {item.label}
              </Label>
              <motion.svg
              ...
              >
                <motion.path
                  ...
                  className="stroke-neutral-900/60 dark:stroke-neutral-100/40"
                />
              </motion.svg>
            </div>
          </div>
