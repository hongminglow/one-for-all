export const code = `import { cva } from "class-variance-authority";
...
const highlightVariants = cva("relative inline-block", {
  variants: {
    ...
    color: {
      primary:
        "[--highlight-color:var(--primary)] [&_path]:[stroke:var(--highlight-color)]",
      secondary:
        "[--highlight-color:var(--secondary)] [&_path]:[stroke:var(--highlight-color)]",
      accent:
        "[--highlight-color:var(--accent)] [&_path]:[stroke:var(--highlight-color)]",
      destructive:
        "[--highlight-color:var(--destructive)] [&_path]:[stroke:var(--highlight-color)]",
    },
  },
  defaultVariants: {
    variant: "underline",
