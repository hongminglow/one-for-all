...
function CompactConfettiDemo(props: { particleCount?: number; spread?: number }) {
...
const RadixPopoverDemo = ({ side, sideOffset, align, alignOffset }: RadixPopoverDemoProps) => {
	return (
		<Popover>
...
export function renderDemo(component: ComponentItem, props?: any) {
	...
	switch (true) {
		...
		case slug === "copy-button" || title.includes("copy button"):
			return (
				<div className="flex items-center justify-center" style={{ height: 160 }}>
					<CopyButton content={props?.text ?? "npm install one-for-all"} variant="outline" />
				</div>
			);
			...
			return (
				<div className="w-full ">
					<SpotlightCard className="custom-spotlight-card" spotlightColor="rgba(0, 229, 255, 0.2)">
						<div className="text-[18px] font-black text-white">Spotlight Card</div>
						<div className="mt-2 text-[13px] font-medium text-white/70">Move your mouse around.</div>
					</SpotlightCard>
				</div>
			);
			...
			return (
				<div className="flex items-center justify-center" style={{ height: 140 }}>
					<div className="text-center">
						<h3 className="mb-2 font-medium text-muted-foreground text-sm">Basic Counter</h3>
						<NumberCounter value={1234.56} decimals={2} prefix="$" className="font-bold text-4xl" />
					</div>
				</div>
			);
				...
				<div className="w-full">
					...
					>
						<Step>
							...
							<div className="mt-2 text-[12px] font-medium text-white/70">Intro content.</div>
						</Step>
						<Step>
							<div className="text-[16px] font-black text-white">Step 2</div>
							<div className="mt-2 text-[12px] font-medium text-white/70">More details.</div>
						</Step>
						<Step>
							<div className="text-[16px] font-black text-white">Step 3</div>
							<div className="mt-2 text-[12px] font-medium text-white/70">Finish.</div>
						</Step>
					</Stepper>
				</div>
			);
			...
			return (
				<div className="w-full h-full min-h-[500px] bg-black rounded-xl overflow-hidden relative">
					<Lanyard
						...
						cardGLB={props?.cardGLB ?? "https://reactbits.dev/assets/3d/card.glb"}
				...
				<div className="w-full min-h-[400px] p-8 bg-(--sb-bg) rounded-xl border border-(--sb-border)">
					...
					>
						<div className="flex flex-col items-center gap-4">
							<h2 className="text-(--sb-text-strong) text-2xl font-bold">Click anywhere!</h2>
							<p className="text-[var(--sb-text-dim)]">Interactive spark effect on click</p>
						</div>
					</ClickSpark>
				</div>
			);
			...
			return (
				<div className="flex flex-col items-center justify-center w-full min-h-[300px] p-8 space-y-8 bg-(--sb-bg)">
					<TargetCursor
						...
						{...props}
					/>
					<h2 className="text-xl font-bold text-(--sb-text-strong)">Hover over elements to see the cursor lock in!</h2>
					...
					<p className="text-sm text-(--sb-text-muted) text-center max-w-md">
						The Target Cursor is fixed-position. When it hovers over elements matching the <code>targetSelector</code>,
						its corners snap to the element&apos;s bounds.
					</p>
				</div>
			);
			...
			return (
				<div className="relative w-full h-[400px] bg-black overflow-hidden rounded-xl border border-(--sb-border)">
					...
					<div className="absolute inset-x-0 bottom-0 p-6 bg-linear-to-t from-black/80 to-transparent pointer-events-none">
						...
						<p className="text-white/60 text-sm">Interactive volumetric cursor trail</p>
					</div>
				</div>
			);
			...
			return (
				<div className="w-full h-[500px] bg-black relative overflow-hidden rounded-xl border border-(--sb-border)">
					...
					<div className="absolute inset-0 flex items-center justify-center pointer-events-none">
						<h3 className="text-white text-3xl font-bold opacity-50">Move Mouse</h3>
					</div>
				</div>
			);
		...
		case slug.includes("circular-gallery") || title.includes("circular gallery"):
			return (
			...
			return (
				<div className="relative h-[220px] w-full overflow-hidden rounded-2xl border border-[var(--sb-border-2)] bg-(--sb-bg)">
					<LetterGlitch
						...
						characters={props?.characters ?? "ABCDEFGHIJKLMNOPQRSTUVWXYZ!@#$&*()-_+=/[]{};:<>.,0123456789"}
						{...props}
					/>
				</div>
			);
		...
		case slug.includes("animated-theme-toggle") || title.includes("theme toggle"):
			return (
				<div className="flex items-center justify-center" style={{ height: 140 }}>
					<AnimatedThemeToggle />
				</div>
			...
			return (
				<div className="flex items-center justify-center" style={{ height: 180 }}>
					<GitHubStarButton
						...
						stars={typeof props?.stars === "number" && props.stars > 0 ? props.stars : undefined}
					/>
				</div>
			);
		...
		case slug.includes("image-sphere") || title.includes("image sphere"):
			return (
				<div className="flex items-center justify-center" style={{ height: 420 }}>
					<SphereImageGrid images={DEMO_IMAGES} containerSize={400} sphereRadius={180} autoRotate={true} />
				</div>
			);
		...
		case slug === "sparkles-text" || title.includes("sparkles"):
			return (
				<div className="flex items-center justify-center" style={{ height: 220 }}>
					<SparklesText sparklesCount={props?.sparklesCount ?? 10}>Sparkles</SparklesText>
				</div>
			);
...
console.log(fibonacci(10));`}
  ...
  Click me
						...
						preview={
							<button className="rounded bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700">Click me</button>
						}
					/>
				</div>
			);
		...
		case slug.includes("android") || title.includes("android") || slug === "device-mock":
			return (
		...
		case slug.includes("iphone") || title.includes("iphone") || slug === "device-mock-2":
			return (
				<div className="w-full flex items-center justify-center p-8">
					<IPhoneMock />
				</div>
		...
		case slug.includes("mac-os-dock") || slug.includes("macos-dock") || title.includes("mac os dock"):
			return (
		...
		case slug.includes("credit-card") || title.includes("credit card"):
			return (
				<div className="w-full flex items-center justify-center">
					<CreditCard number={props?.number} name={props?.name} expiry={props?.expiry} />
				</div>
			);
		...
		case slug.includes("image-zoom") || title.includes("image zoom"):
			return (
				<div className="w-full flex items-center justify-center py-10">
					<ImageZoom
						src={props?.src ?? "https://images.unsplash.com/photo-1461749280684-dccba630e2f6?w=800&q=80"}
						alt="Demo Image"
						className="h-64 w-96"
					/>
				</div>
		...
		case slug.includes("animated-testimonials") || title.includes("animated testimonials"):
			return (
				<div className="w-full py-10">
		...
		case slug.includes("animated-tooltip") || title.includes("animated tooltip"):
			return (
				<div className="w-full py-10">
					<AnimatedTooltip />
				</div>
		...
		case slug.includes("tabs-premium") || title.includes("tabs premium") || slug === "tabs":
			return (
				<div className="w-full py-10">
					<TabsPremium
						tabs={[
						...
						commands={[
							{
								...
								output: ["Checking registries...", "Resolving dependencies...", "Installed 15 components."],
							},
							{
								command: "npm run dev",
		...
		case slug === "progress" || title.includes("progress"):
			return (
				<div className="w-full rounded-2xl border border-[var(--sb-border-2)] bg-(--sb-card) p-6">
					<div className="text-[14px] font-black text-(--sb-text-strong)">Progress</div>
		...
		case slug === "flip-card" || title.includes("flip card"):
			return (
				<div className="flex items-center justify-center p-4" style={{ height: 420 }}>
					<FlipCard
						data={{
							name: "Hong Ming",
		...
		case slug === "motion-carousel" || title.includes("motion carousel"):
			return (
				<div className="flex items-center justify-center w-full px-4" style={{ height: 420 }}>
					<MotionCarousel slides={props?.slides ?? [0, 1, 2, 3, 4]} options={{ loop: true }} />
				</div>
			);
			...
			return (
				<div className="relative h-[400px] w-full overflow-hidden rounded-xl border">
					...
					<div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
						<h2 className="text-4xl font-bold text-white drop-shadow-lg">Hole Background</h2>
					</div>
				</div>
			);
		...
		case slug === "playful-todolist" || title.includes("todolist") || title.includes("todo"):
			return (
				<div className="flex items-center justify-center" style={{ height: 420 }}>
					<PlayfulTodoList />
				</div>
		...
		case slug === "magnet" || title.includes("magnet"):
			return (
				<div className="flex items-center justify-center" style={{ height: 240 }}>
					<Magnet strength={props?.strength ?? 0.25} radius={props?.radius ?? 160}>
						<button
							type="button"
		...
		case slug === "decay-card" || title.includes("decay"):
			return (
				<div className="flex items-center justify-center" style={{ height: 260 }}>
					<DecayCard>
						<div className="text-[16px] font-black text-(--sb-text-strong)">Decay Card</div>
						<div className="mt-2 text-[13px] font-medium text-(--sb-text-muted)">SVG filter displacement effect.</div>
					</DecayCard>
				</div>
			);
				...
				<div className="h-[220px] w-full max-w-[620px] overflow-auto rounded-2xl border border-[var(--sb-border-2)] bg-(--sb-bg) p-4 sb-scroll">
					...
					<FadeContent>
						<div className="rounded-2xl border border-[var(--sb-border-2)] bg-(--sb-card) p-5">
							<div className="text-[14px] font-black text-(--sb-text-strong)">Fade Content</div>
							<div className="mt-1 text-[12px] font-medium text-(--sb-text-muted)">Scroll inside this panel.</div>
						</div>
					</FadeContent>
					<div className="h-[180px]" />
				</div>
		...
		case slug === "pixel-card" || title.includes("pixel card"):
			return (
				<div className="flex items-center justify-center" style={{ height: 260 }}>
					<PixelCard>
						<div className="text-[16px] font-black text-(--sb-text-strong)">Pixel Card</div>
						<div className="mt-2 text-[13px] font-medium text-(--sb-text-muted)">Hover for pixel overlay.</div>
					</PixelCard>
				</div>
			);
		...
		case slug === "true-focus" || title.includes("true focus"):
			return (
				<div className="flex items-center justify-center" style={{ height: 220 }}>
					<TrueFocus text={props?.text ?? "Focus moves across words"} intervalMs={props?.intervalMs ?? 1400} />
				</div>
			);
			...
			return (
				<div className="flex items-center justify-center p-8 bg-black min-h-[400px] rounded-xl">
					...
					>
						...
						<p className="mt-4 text-white/60 relative z-10">Hover over this card to see the spotlight effect.</p>
					</SpotlightCard>
				</div>
			);
		...
		case slug.includes("area-gradient") || title.includes("area gradient") || slug.includes("gradient-area-chart"):
			return (
		...
		case slug.includes("bar-horizontal") || title.includes("bar horizontal") || slug.includes("horizontal-bar"):
			return (
				<div className="w-full max-w-[600px] p-4">
					<BarHorizontal />
				</div>
		...
		case slug.includes("bar-interactive") || title.includes("bar interactive") || slug.includes("interactive-bar"):
			return (
				<div className="w-full max-w-[600px] p-4">
					<BarInteractive />
				</div>
		...
		case slug.includes("radar-dots") || title.includes("radar dots") || slug.includes("radar-chart"):
			return (
				<div className="w-full p-4">
					<RadarDots />
				</div>
	...
	return (
		<div className="w-full">
			<div className="inline-flex items-center gap-3">
				...
				<div>
					<div className="text-[13px] font-extrabold text-(--sb-text-strong)">{component.title}</div>
					<div className="text-[12px] font-medium text-(--sb-text-muted)">Local demo preview</div>
				</div>
			</div>
		</div>
	);
		...
		return [
			{
				...
				param: "imageSrc",
				label: "Image Source",
				defaultValue: "https://images.unsplash.com/photo-1579546929518-9e396f3cc809?w=500&auto=format&fit=crop&q=60",
			},
			{
				type: "number",
				param: "width",
...
export function getDemoCode(component: ComponentItem) {
	...
	if (slug.includes("carousel") || title.includes("carousel")) return carouselCode;
	if (slug.includes("spotlight-card") || title.includes("spotlight")) return spotlightCardCode;
	if (slug.includes("flowing-menu") || title.includes("flowing menu")) return flowingMenuCode;
	if (slug.includes("elastic-slider") || title.includes("elastic slider")) return elasticSliderCode;
	if (slug.includes("counter") || title.includes("counter")) return counterCode;
	if (slug.includes("infinite-menu") || title.includes("infinite menu")) return infiniteMenuCode;
	...
	if (slug.includes("liquid-ether") || title.includes("liquid ether")) return liquidEtherCode;
	if (slug.includes("prism") || title.includes("prism")) return prismCode;
	if (slug.includes("dark-veil") || title.includes("dark veil")) return darkVeilCode;
	if (slug.includes("light-pillar") || title.includes("light pillar")) return lightPillarCode;
	if (slug.includes("floating-lines") || title.includes("floating lines")) return floatingLinesCode;
	if (slug.includes("light-rays") || title.includes("light rays")) return lightRaysCode;
	if (slug.includes("color-bends") || title.includes("color bends")) return colorBendsCode;

	if (slug.includes("particles") || title.includes("particles")) return particlesCode;
	if (slug.includes("grid-scan") || title.includes("grid scan")) return gridScanCode;
	if (slug.includes("lightning") || title.includes("lightning")) return lightningCode;
	if (slug.includes("galaxy") || title.includes("galaxy")) return galaxyCode;
	if (slug.includes("dot-grid") || title.includes("dot grid")) return dotGridCode;
	if (slug.includes("hyperspeed") || title.includes("hyperspeed")) return hyperspeedCode;
	...
	if (slug.includes("letter-glitch") || title.includes("letter glitch")) return letterGlitchCode;
	if (slug.includes("grid-motion") || title.includes("grid motion")) return gridMotionCode;

	if (slug.includes("rainbow-button") || title.includes("rainbow button")) return rainbowButtonCode;
	if (slug.includes("gooey-text-morphing") || title.includes("gooey")) return gooeyTextMorphingCode;
	if (slug.includes("highlight-text") || title.includes("highlight text")) return highlightTextCode;
	if (slug.includes("number-counter") || title.includes("number counter")) return numberCounterCode;
	if (slug.includes("rotate-text") || title.includes("rotate text")) return rotateTextCode;
	if (slug.includes("typewriter-text") || title.includes("typewriter text")) return typewriterTextJolyCode;
	if (slug.includes("ai-prompt-box") || title.includes("ai prompt")) return aiPromptBoxCode;
	if (slug.includes("animated-theme-toggle") || title.includes("theme toggle")) return animatedThemeToggleCode;
	if (slug.includes("date-wheel-picker") || title.includes("date wheel")) return dateWheelPickerCode;
	if (slug.includes("feedback-widget") || title.includes("feedback")) return feedbackWidgetCode;
	if (slug.includes("file-tree") || title.includes("file tree")) return fileTreeCode;
	if (slug.includes("animated-beam") || title.includes("animated beam")) return animatedBeamCode;
	if (slug.includes("expanded-map") || title.includes("expanded map")) return expandedMapCode;
	if (slug.includes("github-star") || title.includes("github star")) return githubStarCode;
	if (slug.includes("hover-preview") || title.includes("hover preview")) return hoverPreviewCode;
	if (slug.includes("image-sphere") || title.includes("image sphere")) return imageSphereCode;
	if (slug === "border-beam" || title.includes("border beam")) return borderBeamCode;
	if (slug === "shine-border" || title.includes("shine border")) return shineBorderCode;
	if (slug === "magic-card" || title.includes("magic card")) return magicCardCode;
	if (slug === "neon-gradient-card" || title.includes("neon gradient")) return neonGradientCardCode;
	if (slug === "circular-progress-bar" || title.includes("circular progress")) return circularProgressBarCode;
	if (slug === "icon-cloud" || title.includes("icon cloud")) return iconCloudCode;
	if (slug === "compact-confetti" || title.includes("compact confetti")) return compactConfettiCode;
	if (slug === "video-text" || title.includes("video text")) return videoTextCode;
	if (slug === "text-reveal" || title.includes("text reveal")) return textRevealCode;
	if (slug === "sparkles-text" || title.includes("sparkles")) return sparklesTextCode;
	if (slug === "code-comparison" || title.includes("code comparison")) return codeComparisonCode;
	if (slug === "scroll-progress" || title.includes("scroll progress")) return scrollProgressCode;
	if (slug === "calendar") return shadcnCalendarCode;

	if (slug === "copy-button" || title.includes("copy button")) return copyButtonCode;
	if (slug === "flip-button" || title.includes("flip button")) return flipButtonCode;
	if (slug === "ripple-button" || title.includes("ripple button")) return rippleButtonCode;
	...
	if (slug === "motion-carousel" || title.includes("motion carousel")) return motionCarouselCode;
	if (slug === "radial-intro" || title.includes("radial intro")) return radialIntroCode;
	if (slug === "radial-menu" || title.includes("radial menu")) return radialMenuCode;
	if (slug === "hole-background" || title.includes("hole background")) return holeBackgroundCode;
	if (slug === "management-bar" || title.includes("management bar")) return managementBarCode;
	if (slug === "playful-todolist" || title.includes("todolist") || title.includes("todo")) return playfulTodoListCode;
	...
	if (slug === "fade-content" || title.includes("fade content")) return fadeContentCode;
	if (slug === "pixel-card" || title.includes("pixel card")) return pixelCardCode;
	if (slug === "true-focus" || title.includes("true focus")) return trueFocusCode;

	if (slug.includes("electric-border") || title.includes("electric border")) return electricBorderCode;
	if (slug.includes("antigravity") || title.includes("antigravity")) return antigravityCode;
	if (slug.includes("logo-loop") || title.includes("logo loop")) return logoLoopCode;
	if (slug.includes("target-cursor") || title.includes("target cursor")) return targetCursorCode;
	if (slug.includes("laser-flow") || title.includes("laser flow")) return laserFlowCode;
	if (slug.includes("magnet-lines") || title.includes("magnet lines")) return magnetLinesCode;
	if (slug.includes("ghost-cursor") || title.includes("ghost cursor")) return ghostCursorCode;
	if (slug.includes("click-spark") || title.includes("click spark")) return clickSparkCode;
	if (slug.includes("sticker-peel") || title.includes("sticker peel")) return stickerPeelCode;

	if (slug.includes("splash-cursor") || title.includes("splash cursor")) return splashCursorCode;
	if (slug.includes("star-border") || title.includes("star border")) return starBorderCode;
	if (slug.includes("animated-list") || title.includes("animated list")) return animatedListCode;
	if (slug.includes("scroll-stack") || title.includes("scroll stack")) return scrollStackCode;
	if (slug.includes("magic-bento") || title.includes("magic bento")) return magicBentoCode;
	if (slug.includes("circular-gallery") || title.includes("circular gallery")) return circularGalleryCode;
	if (slug.includes("image-trail") || title.includes("image trail")) return imageTrailCode;
	if (slug.includes("stack") || title.includes("stack")) return stackCode;
	if (slug.includes("fluid-glass") || title.includes("fluid glass")) return fluidGlassCode;
	if (slug.includes("masonry") || title.includes("masonry")) return masonryCode;
	if (slug.includes("model-viewer") || title.includes("model viewer")) return modelViewerCode;
...
export function getApiReference(component: ComponentItem): ApiProp[] | null {
		...
		return [
			{
				...
				type: "any[]",
				default: "[]",
				description: "Placeholder items (full upstream implementation not embedded)",
			},
			{
				prop: "scale",
				type: "number",
		...
		return [
			{
				...
				type: "DockItemData[]",
				default: "required",
				description: "Items to display (icon, label, onClick, optional className)",
			},
			{
				prop: "className",
				type: "string",
	...
	if (slug === "playful-todolist" || title.includes("todolist") || title.includes("todo")) {
		return [
			{
				prop: "className",
				type: "string",
