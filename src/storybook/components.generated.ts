...
export const COMPONENTS: ComponentItem[] = [
  {
    ...
    title: "Split Text",
    description:
      "Splits a heading into segments so you can animate parts independently.",
    tags: ["split", "text", "animations"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Circular Text",
    description:
      "Renders text around a circle for badges, stamps, and hero accents.",
    tags: ["circular", "text", "animations", "spinning", "rotating"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["shiny", "text", "animations", "highlight", "shimmer"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["curved", "marquee", "text", "animations", "loop"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["fuzzy", "text", "animations", "horror", "ghost"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Gradient Text",
    description:
      "Applies a multi-color gradient fill to text (great for headings).",
    tags: ["gradient", "text", "multi-color", "gradient-text"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["falling", "text", "animations", "funny"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["text", "cursor", "animations", "pointer", "hover"],
    library: "React-Bits",
  ...
  },
  {
    ...
    description:
      "Reveals text by cycling through random characters (decryption effect).",
    tags: ["decrypted", "text", "animations", "masking", "secure"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["scroll", "float", "text", "animations"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["scroll", "reveal", "text", "animations", "scrolling"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["rotating", "text", "animations", "changing", "flip"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Glitch Text",
    description:
      "Creates a glitchy, distorted text effect for cyber/retro styles.",
    tags: ["glitch", "text", "animations", "bug", "horror"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["variable", "proximity", "text", "animations", "scaling"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["count", "up", "text", "animations", "counting", "increment"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["electric", "border", "lightning", "thunder", "chaos", "thor"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["antigravity", "animations", "gravity", "zero-gravity"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["logo", "loop", "marquee", "horizontal", "advertisement"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["target", "cursor", "animations", "pointer", "snap", "sniper"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["laser", "flow", "strike", "god", "dreamlike"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["magnet", "lines", "animations", "playful", "north", "south"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["ghost", "cursor", "animations", "pointer", "hover", "horror"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["click", "spark", "mini fireworks", "celebrate"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["image", "trail", "animations", "images", "following", "hover"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["splash", "cursor", "animations", "pointer", "hover", "smoke"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["animated", "list", "list item", "scrolling", "recycle"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["scroll", "stack", "stacking", "card", "domino"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["magic", "bento", "hover", "magical", "fantasy", "card"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["circular", "gallery", "loop", "drag", "carousel"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["image", "stack", "stacking", "drag", "arrange"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["masonry", "gallery", "images", "layout"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["modal", "viewer", "model", "3D", "preview"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["dock", "navigation", "toolbar", "macOS"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["carousel", "slider", "horizontal", "paging"],
    library: "React-Bits",
  ...
  },
  {
    ...
    description: "An interactable card component on hovering.",
    tags: ["spotlight", "card", "hover", "interactable"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["flowing", "menu", "navigation", "marquee"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["elastic", "slider", "volume", "speaker", "loud", "silence"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Counter",
    description: "Animates a number from 0 to a target value (stats/metrics).",
    tags: ["counter", "counting", "increment", "numbers"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["infinite", "menu", "earth", "bizarre"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["step", "stepper", "forms", "sequential"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Liquid Ether",
    description:
      "Animated background preset: Liquid Ether (drop into a section/hero).",
    tags: ["liquid", "ether", "backgrounds", "glowing", "water", "moving"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Prism",
    description:
      "Animated background preset: Prism (drop into a section/hero).",
    tags: ["prism", "backgrounds", "spotlight", "shine", "focus"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Dark Veil",
    description:
      "Animated background preset: Dark Veil (drop into a section/hero).",
    tags: ["dark", "veil", "backgrounds", "moving", "mystery"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Light Pillar",
    description:
      "Animated background preset: Light Pillar (drop into a section/hero).",
    tags: ["light", "pillar", "backgrounds", "strike", "dreamlike"],
    library: "React-Bits",
  ...
  },
  {
    ...
    description:
      "Animated background preset: Floating Lines (drop into a section/hero).",
    tags: ["floating", "lines", "backgrounds", "wave", "moving"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Light Rays",
    description:
      "Animated background preset: Light Rays (drop into a section/hero).",
    tags: [
      "light",
      "rays",
      "backgrounds",
  ...
  },
  {
    ...
    title: "Color Bends",
    description:
      "Animated background preset: Color Bends (drop into a section/hero).",
    tags: ["color", "bends", "backgrounds", "interactable", "bizarre"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Particles",
    description:
      "Animated background preset: Particles (drop into a section/hero).",
    tags: ["particles", "backgrounds", "galaxy", "space", "dark"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Grid Scan",
    description:
      "Animated background preset: Grid Scan (drop into a section/hero).",
    tags: ["grid", "scan", "backgrounds", "3D", "4D", "futuristic"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Lightning",
    description:
      "Animated background preset: Lightning (drop into a section/hero).",
    tags: ["lightning", "backgrounds", "horror", "thunder", "electric"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Galaxy",
    description:
      "Animated background preset: Galaxy (drop into a section/hero).",
    tags: ["galaxy", "backgrounds", "interactable", "space", "stars"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Dot Grid",
    description:
      "Animated background preset: Dot Grid (drop into a section/hero).",
    tags: ["dot", "grid", "backgrounds", "interactable"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Hyperspeed",
    description:
      "Animated background preset: Hyperspeed (drop into a section/hero).",
    tags: ["hyperspeed", "backgrounds", "speed", "racing", "futuristic"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Ballpit",
    description:
      "Animated background preset: Ballpit (drop into a section/hero).",
    tags: ["ballpit", "backgrounds", "balls", "playful", "balloon"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["orbs", "backgrounds", "gradient", "circle"],
    library: "React-Bits",
    url: "https://reactbits.dev/backgrounds/orbs",
  ...
  },
  {
    ...
    description:
      "Creates a glitchy, distorted text effect for cyber/retro styles.",
    tags: ["letter", "glitch", "backgrounds", "bug", "hacks", "hacker"],
    library: "React-Bits",
  ...
  },
  {
    ...
    title: "Grid Motion",
    description:
      "Animated background preset: Grid Motion (drop into a section/hero).",
    tags: ["grid", "motion", "backgrounds", "carousel", "3D"],
    library: "React-Bits",
  ...
  },
  {
    ...
    tags: ["code", "block", "terminal", "command", "coding"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["code", "editor", "terminal", "coding"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["code", "tabs", "coding", "terminal", "commands"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["sandbox", "practice", "codepen", "codesandbox", "coding"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["ganttchart", "gantt", "planning", "timeline", "project"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["kanban", "discipline", "supervise", "daily task", "timeline"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["device", "mock", "android", "samsung"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["rating", "feedback", "comment", "stars"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["credit", "card", "banks", "flip", "payment"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["color", "picker", "colorful", "input", "forms"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["combobox", "form", "input", "select", "autocomplete"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["dropzone", "upload", "file", "drag", "drop", "input"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["image", "zoom", "scale", "magnifying"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["image", "crop", "portion", "cut", "edit", "photoshop"],
    library: "shadcn",
  ...
  },
  {
    ...
    library: "shadcn",
    url: "https://www.shadcn.io/components/animated-cursor",
  ...
  },
  {
    ...
    description:
      "Animated Testimonials — a UI component reference from shadcn.",
    tags: ["animated", "testimonials", "card", "swiper"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["animated", "tooltip", "avatar", "avatar-group"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["glimpse", "preview", "link", "images"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["pin", "list", "tasks", "items", "priority"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["spinner", "loading", "indicator", "spinning"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["banner", "notification", "latest", "news"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["marquee", "loop", "automate", "horizontal"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["calendar", "date", "picker", "input", "simple"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["mini", "calendar", "convenient", "compact", "horizontal"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["comparison", "slider", "versus", "vs", "drag", "compare"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["kbd", "keyboard", "shortcut", "keys"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["qr", "code", "download", "scan", "barcode"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["status", "ping", "blinking", "online", "offline"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["terminal", "command", "shell", "console"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["video", "player", "youtube", "media", "video-player"],
    library: "shadcn",
  ...
  },
  {
    ...
    description:
      "Animated background preset: Beam Collision (drop into a section/hero).",
    tags: ["beam", "collision", "background", "rain", "star wars"],
    library: "shadcn",
  ...
  },
  {
    ...
    title: "Confetti",
    description:
      "Animated background preset: Confetti (drop into a section/hero).",
    tags: ["confetti", "background", "celebrate", "party", "happy birthday"],
    library: "shadcn",
  ...
  },
  {
    ...
    title: "Fireworks",
    description:
      "Animated background preset: Fireworks (drop into a section/hero).",
    tags: ["fireworks", "background", "cny", "chinese new years", "celebrate"],
    library: "shadcn",
  ...
  },
  {
    ...
    title: "Meteors",
    description:
      "Animated background preset: Meteors (drop into a section/hero).",
    tags: ["meteors", "background", "dreamlike", "space", "wishes"],
    library: "shadcn",
    url: "https://www.shadcn.io/background/meteors",
  ...
  },
  {
    ...
    title: "Orbits",
    description:
      "Animated background preset: Orbits (drop into a section/hero).",
    tags: ["orbits", "background", "space", "solar system", "sun", "earth"],
    library: "shadcn",
    url: "https://www.shadcn.io/background/orbits",
  ...
  },
  {
    ...
    tags: ["rain", "background", "raining", "sad", "rainy day"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["snow", "background", "merry christmas", "winter", "romantic"],
    library: "shadcn",
  ...
  },
  {
    ...
    title: "Vortex",
    description:
      "Animated background preset: Vortex (drop into a section/hero).",
    tags: ["vortex", "background", "dreamlike", "valentine day"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["gradient", "area", "chart", "charts", "statistics"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["horizontal", "bar", "charts", "statistics"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["interactive", "bar", "charts", "statistics", "vertical"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["pie", "donut", "charts", "statistics", "circle"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["radar", "chart", "charts", "dots", "gaming", "statistics"],
    library: "shadcn",
  ...
  },
  {
    ...
    tags: ["rainbow", "button", "cta", "playful", "gradient"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["gooey", "text", "morphing", "docs", "horror"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["highlight", "text", "notes", "animations", "underline"],
    library: "Joly UI",
  ...
  },
  {
    ...
    description: "Animates a number from 0 to a target value (stats/metrics).",
    tags: ["number", "counter", "text", "numbers", "increment"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["rotate", "text", "animations", "flip"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["typewriter", "text", "animations", "typing", "human-like"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["ai", "prompt", "box", "inputs", "chatgpt", "gemini"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["animated", "theme", "toggle", "swap", "light", "dark"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["calendar", "input", "docs", "inputs", "popover"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["date", "wheel", "picker", "inputs", "scroll", "drag"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["feedback", "widget", "joy", "unsatisfy", "comments", "angry"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["file", "tree", "docs", "navigation", "folder"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["animated", "beam", "docs", "creative", "transfer"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["expanded", "map", "location", "geography", "real-time"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["github", "star", "stars", "animating", "increment"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["hover", "preview", "images", "links"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["image", "sphere", "earth", "rotate"],
    library: "Joly UI",
  ...
  },
  {
    ...
    tags: ["popover", "docs", "overlay", "pop up"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["sheet", "docs", "overlay", "bottom sheet", "drawer"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["copy", "button", "docs", "cta", "clipboard"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["flip", "button", "docs", "cta", "swap", "hover"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["ripple", "button", "docs", "cta", "interactable"],
    library: "Animated UI",
  ...
  },
  {
    ...
    description:
      "Animated background preset: Hole Background (drop into a section/hero).",
    tags: ["hole", "background", "magical", "infinite", "dizzy"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["flip", "card", "docs", "profile"],
    library: "Animated UI",
    url: "https://animate-ui.com/docs/components/community/flip-card",
    installCommand:
      "npx shadcn@latest add @animate-ui/components-community-flip-card",
    apiReferenceUrl: null,
  },
  {
    id: "cmp_138",
    ...
    tags: ["management", "bar", "bottom bar", "menus"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["motion", "carousel", "slider", "horizontal"],
    library: "Animated UI",
  ...
  },
  {
    ...
    description:
      "Playful TodoList — a UI component reference from Animated UI.",
    tags: ["playful", "todolist", "highlight", "underline", "tasks"],
    library: "Animated UI",
  ...
  },
  {
    ...
    tags: ["radial", "intro", "spinning", "rotating", "wheel"],
    library: "Animated UI",
    url: "https://animate-ui.com/docs/components/community/radial-intro",
    installCommand:
      "npx shadcn@latest add @animate-ui/components-community-radial-intro",
    apiReferenceUrl: null,
  },
  {
    id: "cmp_142",
    ...
    tags: ["radial", "menu", "docs", "navigation", "right-click"],
    library: "Animated UI",
    url: "https://animate-ui.com/docs/components/community/radial-menu",
    installCommand:
      "npx shadcn@latest add @animate-ui/components-community-radial-menu",
    apiReferenceUrl: null,
  },
  {
    id: "cmp_143",
    ...
    tags: ["icons", "cloud", "canvas", "sponsor", "collections"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["border", "beam", "card", "gradient"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["border", "shine", "card", "gradient"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["card", "hover", "gradient", "border"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["confetti", "celebration", "canvas", "happy", "joyful"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["video", "text", "backgrounds", "playing"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["text", "reveal", "hide", "scrolling", "progressive"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["sparkles", "text", "confident", "shiny"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["code", "comparison", "commit", "github", "before", "after"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["scroll", "progress", "loading", "progressive"],
    library: "Magic UI",
  ...
  },
  {
    ...
    tags: ["card", "neon", "gradient", "glowing"],
    library: "Magic UI",
  ...
  },
  {
    ...
    description:
      "Circular Progress Bar — a UI component reference from Magic UI.",
    tags: ["circular", "progress", "bar", "loading", "progressive"],
    library: "Magic UI",
  ...
  },
  {
    ...
    description:
      "Draggable Card — a UI component reference from Aceternity UI.",
    tags: ["draggable", "card", "choose", "throw", "drag", "photos"],
  ...
  },
  {
    ...
    tags: ["hero", "parallax", "animatable", "transition", "futuristic"],
    library: "Aceternity UI",
  ...
  },
  {
    ...
    tags: ["image", "compare", "code", "futuristic", "commit"],
    library: "Aceternity UI",
  ...
  },
  {
    ...
    slug: "liquid-text",
    title: "Liquid Text",
    description: "Liquid Text — a UI component reference from Vengeance UI.",
    tags: ["liquid", "text", "distortion", "animation", "water"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/liquid-text",
    installCommand:
      'npx shadcn@latest add "https://www.vengenceui.com/r/liquid-text.json"',
    apiReferenceUrl: null,
  },
  {
    id: "cmp_160",
    ...
    slug: "liquid-ocean",
    title: "Liquid Ocean",
    description: "Liquid Ocean — a UI component reference from Vengeance UI.",
    tags: ["liquid", "ocean", "background", "animation", "wave"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/liquid-ocean",
    installCommand:
  ...
  },
  {
    ...
    slug: "flip-text",
    title: "Flip Text",
    description: "Flip Text — a UI component reference from Vengeance UI.",
    tags: ["flip", "text", "typography", "animation"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/flip-text",
    installCommand:
  ...
  },
  {
    ...
    description:
      "Perspective Grid — a UI component reference from Vengeance UI.",
    tags: ["perspective", "grid", "3d", "3D Grid", "puzzle"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/perspective-grid",
    installCommand:
      'npx shadcn@latest add "https://www.vengenceui.com/r/perspective-grid.json"',
    apiReferenceUrl: null,
  },
  {
    id: "cmp_163",
    ...
    description:
      "Interactive Book — a UI component reference from Vengeance UI.",
    tags: ["interactive", "book", "3d", "flip"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/interactive-book",
    installCommand:
      'npx shadcn@latest add "https://www.vengenceui.com/r/interactive-book.json"',
    apiReferenceUrl: null,
  },
  {
    id: "cmp_164",
    ...
    slug: "reveal-loader",
    title: "Reveal Loader",
    description: "Reveal Loader — a UI component reference from Vengeance UI.",
    tags: ["reveal", "loader", "loading", "transition", "splash"],
    library: "Vengeance UI",
    url: "https://www.vengenceui.com/docs/reveal-loader",
    installCommand:
